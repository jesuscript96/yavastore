...
export default function Layout({ children }) {
  ...
  const handleSignOut = async () => {
    ...
    try {
      ...
      // Usar el servicio de logout mejorado
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-xl font-bold text-primary-600">Yava</h1>
            <button
          ...
          <div className="border-t border-gray-200 p-4">
            ...
            <button
              ...
              className="flex w-full items-center px-2 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
